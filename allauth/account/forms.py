...
class LoginForm(forms.Form):
    ...
    password = PasswordField(label='Введіть свій пароль:')
    ...
    def __init__(self, *args, **kwargs):
        ...
        if app_settings.AUTHENTICATION_METHOD == AuthenticationMethod.EMAIL:
            ...
            login_field = forms.EmailField(label='Введіть свою адресу своєї електронної пошти:',
                                           widget=login_widget)
...
class ResetPasswordForm(forms.Form):
    ...
    email = forms.EmailField(
        label=_(""),
        required=True,
        widget=forms.TextInput(attrs={"type": "email", "size": "30", "placeholder": "Введіть адресу своєї електронної пошти", 'class': 'form-control input-lg'}))
